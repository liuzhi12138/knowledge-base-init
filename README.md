...
Phase 1  骨架生成    → 创建 docs/ai-context/ 目录结构和导航文件
...
└── assets/
    ...
    └── templates/                        # 产出文档模板
        ├── agents-template.md            # → AGENTS.md：AI 编码入口文件
...
**Q: 已有 AGENTS.md 或 docs/ai-context/ 目录怎么办？**
A: 技能会自动检测。已有 AGENTS.md 会在原内容中追加路由表而非覆盖；已有知识库会询问你选择覆盖、增量追加或取消。
